...
export default class App extends React.Component {
  ...
  handleChange = (event) => {
    ...
    this.state.formdata[0][name]=value;
  ...
  render() {
        ...
        <h1>Add Your Personal Details</h1>
          <form >
           ...
           {/* For FullName*/}
            ...
            <TextField id="outlined-basic" onChange={this.handleChange} name='fullName' label="Full Name" size="small" variant="outlined" noValidate required/><br/>
    ...
    />         
     ...
     {/* For phonenumber*/}
        ...
        <div>
        <FormControl className="formControl" >
      <PhoneInput className="PhoneInputInput" name="phonenumber" onChange={this.handleChange} placeholder="Phone Number" value={this.state.Value} onChange={()=>this.setState({Value:this.state.Value})}/>
